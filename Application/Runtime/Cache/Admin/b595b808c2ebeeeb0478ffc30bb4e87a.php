...
<script src="/Public/dwz/js/jquery-2.1.4.min.js" type="text/javascript"></script>
...
<script src="/Public/xheditor/xheditor-1.2.2.min.js" type="text/javascript"></script>
...
<script type="text/javascript" src="/Public/dwz/chart/raphael.js"></script>
<script type="text/javascript" src="/Public/dwz/chart/g.raphael.js"></script>
<script type="text/javascript" src="/Public/dwz/chart/g.bar.js"></script>
<script type="text/javascript" src="/Public/dwz/chart/g.line.js"></script>
<script type="text/javascript" src="/Public/dwz/chart/g.pie.js"></script>
<script type="text/javascript" src="/Public/dwz/chart/g.dot.js"></script>
...
<script src="/Public/dwz/js/dwz.file.js" type="text/javascript"></script>
<script src="/Public/dwz/js/dwz.print.js" type="text/javascript"></script>

<!-- 可以用dwz.min.js替换前面全部dwz.*.js (注意：替换时下面dwz.regional.zh.js还需要引入)
<script src="/Public/dwz/dwz.min.js" type="text/javascript"></script>
-->
...
<body>
	<div id="layout">
		<div id="header">
			...
			<div id="navMenu">
				<ul>
					<?php if(is_array($topmenu)): $k = 0; $__LIST__ = $topmenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li <?php if(($k) == "1"): ?>class="selected"<?php endif; ?> ><a href="<?php echo U('/Index/sidebar',array('id'=>$vo['id']));?>"><span><?php echo ($vo["title"]); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
					<li <?php if(($k) == "1"): ?>class="selected"<?php endif; ?> ><a href="<?php echo U('/Index/sidebar',array('id'=>$vo['id']));?>"><span><?php echo ($vo["title"]); ?></span></a></li><li <?php if(($k) == "1"): ?>class="selected"<?php endif; ?> ><a href="<?php echo U('/Index/sidebar',array('id'=>$vo['id']));?>"><span>信息管理</span></a></li>
					<li <?php if(($k) == "1"): ?>class="selected"<?php endif; ?> ><a href="<?php echo U('/Index/sidebar',array('id'=>$vo['id']));?>"><span><?php echo ($vo["title"]); ?></span></a></li><li <?php if(($k) == "1"): ?>class="selected"<?php endif; ?> ><a href="<?php echo U('/Index/sidebar',array('id'=>$vo['id']));?>"><span>会员管理</span></a></li>
					<li <?php if(($k) == "1"): ?>class="selected"<?php endif; ?> ><a href="<?php echo U('/Index/sidebar',array('id'=>$vo['id']));?>"><span><?php echo ($vo["title"]); ?></span></a></li><li <?php if(($k) == "1"): ?>class="selected"<?php endif; ?> ><a href="<?php echo U('/Index/sidebar',array('id'=>$vo['id']));?>"><span>商品管理</span></a></li>
					<li <?php if(($k) == "1"): ?>class="selected"<?php endif; ?> ><a href="<?php echo U('/Index/sidebar',array('id'=>$vo['id']));?>"><span><?php echo ($vo["title"]); ?></span></a></li><li <?php if(($k) == "1"): ?>class="selected"<?php endif; ?> ><a href="<?php echo U('/Index/sidebar',array('id'=>$vo['id']));?>"><span>订单管理</span></a></li>
					<li <?php if(($k) == "1"): ?>class="selected"<?php endif; ?> ><a href="<?php echo U('/Index/sidebar',array('id'=>$vo['id']));?>"><span><?php echo ($vo["title"]); ?></span></a></li><li <?php if(($k) == "1"): ?>class="selected"<?php endif; ?> ><a href="<?php echo U('/Index/sidebar',array('id'=>$vo['id']));?>"><span>财务管理</span></a></li>
					<li <?php if(($k) == "1"): ?>class="selected"<?php endif; ?> ><a href="<?php echo U('/Index/sidebar',array('id'=>$vo['id']));?>"><span><?php echo ($vo["title"]); ?></span></a></li><li <?php if(($k) == "1"): ?>class="selected"<?php endif; ?> ><a href="<?php echo U('/Index/sidebar',array('id'=>$vo['id']));?>"><span>系统管理</span></a></li>
				</ul>
			</div>
		</div>
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="tabsPage.html" target="navTab">主框架面板</a>
								<ul>
									<li><a href="<?php echo U('Public/main');?>" target="navTab" rel="main">我的主页</a></li>
									<li><a href="<?php echo U('Node/index');?>" target="navTab" rel="main">节点管理</a></li>
